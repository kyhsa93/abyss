...
const ABILITY: Record<number, [string, string]> = {
  ...
  // And the other five classes' books, in the order `slice.json` names them.
  // The words describe the effect the pipeline read rather than translating
  // the client's name, which is the same bargain this table already made for
  // the warrior — 78 is `내려치기` because it puts rage into the next swing,
  // not because of what `Spell.dbc` calls it.
  //
  // A rank is `2` after the word rather than a second word, because a rank is
  // the same ability with bigger numbers, and giving it its own name would be
  // claiming a difference the data does not have.
  465: ['헌신의 기운', '곁에 선 모두의 방어도를 올린다'],
  10290: ['헌신의 기운 2', '더 두터운 기운'],
  498: ['신의 보호', '한동안 맞는 것이 절반이 된다'],
  633: ['손 얹기', '남은 생명을 실어 상처를 단번에 메운다'],
  635: ['성스러운 빛', '빛으로 상처를 메운다'],
  639: ['성스러운 빛 2', '더 크게 메운다'],
  853: ['심판의 망치', '잠시 묶어 둔다'],
  1022: ['보호의 축복', '물리적인 공격을 한동안 튕겨낸다'],
  1152: ['정화', '병과 독을 씻어낸다'],
  19740: ['힘의 축복', '한동안 더 세게 친다'],
  20154: ['정의의 일격', '인장이 실린 일격'],
  20271: ['심판', '걸어 둔 인장을 터뜨린다'],
  21084: ['정의의 인장', '휘두를 때마다 빛이 함께 친다'],
  53: ['등 찌르기', '뒤에서 무기 피해의 배 반을 넣는다'],
  674: ['쌍수 무기', '양손에 무기를 든다'],
  921: ['소매치기', '주머니를 턴다'],
  1752: ['사악한 일격', '무기 피해에 얹어 찌르고 연계를 쌓는다'],
  1757: ['사악한 일격 2', '더 깊게 찌른다'],
  1776: ['후벼파기', '눈을 찔러 잠시 멈춰 세운다'],
  1784: ['은신', '몸을 숨기고 천천히 걷는다'],
  2098: ['절개', '쌓아 둔 연계만큼 깊게 벤다'],
  6760: ['절개 2', '더 깊게 벤다'],
  2764: ['던지기', '멀리서 던져 맞힌다'],
  2983: ['전력 질주', '한동안 빨리 달린다'],
  5171: ['난도질', '쌓아 둔 연계만큼 손이 빨라진다'],
  5277: ['회피', '한동안 잘 피한다'],
  6770: ['기절시키기', '눈치채기 전에 재운다'],
  17: ['신의 방패', '일정량의 피해를 대신 받아낸다'],
  139: ['소생', '한동안 조금씩 아문다'],
  585: ['성스러운 일격', '멀리서 빛으로 때린다'],
  591: ['성스러운 일격 2', '더 세게 때린다'],
  586: ['소멸', '이쪽을 덜 보게 만든다'],
  589: ['어둠의 고통', '한동안 계속 아프게 한다'],
  594: ['어둠의 고통 2', '더 오래 아프게 한다'],
  1243: ['인내의 기도', '한동안 체력이 오른다'],
  2006: ['일으키기', '쓰러진 이를 일으킨다'],
  2050: ['하급 치유', '상처를 조금 메운다'],
  2052: ['하급 치유 2', '더 메운다'],
  2053: ['하급 치유 3', '가장 크게 메운다'],
  8092: ['정신 분열', '정신을 직접 때린다'],
  5019: ['지팡이 사격', '들고 있는 것으로 멀리서 친다'],
  116: ['얼음 화살', '느리게 만들며 때린다'],
  205: ['얼음 화살 2', '더 세게 때린다'],
  118: ['변이', '한동안 딴것으로 바꿔 둔다'],
  122: ['서리 고리', '둘레의 발을 묶는다'],
  133: ['화염구', '불덩이를 던지고 한동안 태운다'],
  143: ['화염구 2', '더 큰 불덩이'],
  168: ['서리 갑옷', '방어도가 오른다'],
  7300: ['서리 갑옷 2', '더 두꺼운 서리'],
  1459: ['비전 지능', '한동안 지능이 오른다'],
  2136: ['화염 작렬', '그 자리에서 터뜨린다'],
  5143: ['비전 화살', '화살이 잇달아 날아간다'],
  5504: ['물 만들기', '마실 것을 만들어 낸다'],
  587: ['물 만들기 2', '더 나은 물'],
  5505: ['음식 만들기', '먹을 것을 만들어 낸다'],
  172: ['부패', '한동안 속에서 썩게 한다'],
  348: ['제물', '태우고 한동안 계속 탄다'],
  707: ['제물 2', '더 오래 탄다'],
  686: ['어둠의 화살', '멀리서 어둠을 쏜다'],
  695: ['어둠의 화살 2', '더 세게 쏜다'],
  687: ['악마의 가죽', '방어도가 오른다'],
  696: ['악마의 가죽 2', '더 두꺼운 가죽'],
  688: ['임프 부르기', '작은 악마를 불러낸다'],
  702: ['약화의 저주', '한동안 상대의 힘을 뺀다'],
  980: ['고통의 저주', '한동안 갈수록 아프게 한다'],
  1120: ['영혼 흡수', '붙들고 영혼을 빨아들인다'],
  1454: ['생명 전환', '제 피를 마나로 바꾼다'],
  5782: ['공포', '겁에 질려 달아나게 한다'],
  6201: ['생명석 만들기', '생명을 담은 돌을 만든다'],
}
