...
export const ENCOUNTERS: Encounter[] = [
  {
    ...
    phases: {
      1: { swing: 2.0, slam: 16, puddleCount: 1, raid: 9, ...beats({ brand: 8, crush: 9, fault: 10, shallows: 10, hand: 14, puddle: 9, rot: 33, sunder: 11, soak: 40, burden: 4.6, yoke: 10, schism: 12.5, vigil: 10, chant: 12, gaze: 11, knell: 21, vessel: 23, mirror: 19 }) },
      2: { swing: 1.7, slam: 13, puddleCount: 2, raid: 8, ...beats({ brand: 7, crush: 8, fault: 9, shallows: 9, hand: 12, puddle: 8, rot: 27, sunder: 9, soak: 34, burden: 4.0, yoke: 8.5, schism: 11.0, vigil: 9, chant: 10.5, gaze: 9.5, knell: 18, vessel: 20, mirror: 16.5 }) },
      3: { swing: 1.5, slam: 11, puddleCount: 2, raid: 7, ...beats({ brand: 6, crush: 7, fault: 8, shallows: 8, hand: 10, puddle: 7, rot: 22, sunder: 8, soak: 28, burden: 3.5, yoke: 7.5, schism: 9.5, vigil: 8, chant: 9, gaze: 8, knell: 15, vessel: 17, mirror: 14 }) },
    },
    opening: { slam: 13, raid: 11, ...beats({ hand: 12, brand: 8, crush: 9, fault: 10, shallows: 9, puddle: 9, rot: 22, sunder: 14, soak: 34, burden: 4.5, yoke: 8.5, schism: 8.5, vigil: 9, chant: 10, gaze: 9, knell: 12, vessel: 14, mirror: 10 }) },
    lines: {
  ...
  },
  {
    ...
    phases: {
      1: { swing: 2.1, slam: 18, puddleCount: 1, raid: 7, ...beats({ verdict: 19, echo: 13, puddle: 12, spread: 11, adds: 58, rot: 20, hunt: 52, burden: 4.6, yoke: 10, schism: 12.0, vigil: 10, chant: 12, gaze: 11, knell: 21, vessel: 23, mirror: 19 }) },
      2: { swing: 1.9, slam: 16, puddleCount: 1, raid: 6, ...beats({ verdict: 16, echo: 11, puddle: 11, spread: 9, adds: 50, rot: 16, hunt: 45, burden: 4.0, yoke: 8.5, schism: 10.5, vigil: 9, chant: 10.5, gaze: 9.5, knell: 18, vessel: 20, mirror: 16.5 }) },
      3: { swing: 1.8, slam: 14, puddleCount: 1, raid: 5.5, ...beats({ verdict: 13.5, echo: 9.5, puddle: 10, spread: 8, adds: 42, rot: 14, hunt: 38, burden: 3.5, yoke: 7.5, schism: 9.0, vigil: 8, chant: 9, gaze: 8, knell: 15, vessel: 17, mirror: 14 }) },
    },
    opening: { slam: 15, raid: 9, ...beats({ echo: 10, verdict: 11, puddle: 12, spread: 8, adds: 52, rot: 12, hunt: 44, burden: 4.5, yoke: 8.5, schism: 8.0, vigil: 9, chant: 10, gaze: 9, knell: 12, vessel: 14, mirror: 10 }) },
    lines: {
  ...
  },
  {
    ...
    phases: {
      1: { swing: 1.9, slam: 14, puddleCount: 1, raid: 11, ...beats({ breath: 11, shockwave: 16, adds: 46, sweep: 32, hunt: 44, burden: 4.6, yoke: 10, schism: 13.0, vigil: 10, chant: 12, gaze: 11, knell: 21, vessel: 23, mirror: 19 }) },
      2: { swing: 1.7, slam: 12, puddleCount: 1, raid: 10, ...beats({ breath: 9.5, shockwave: 13, adds: 40, sweep: 28, hunt: 38, burden: 4.0, yoke: 8.5, schism: 11.5, vigil: 9, chant: 10.5, gaze: 9.5, knell: 18, vessel: 20, mirror: 16.5 }) },
      3: { swing: 1.5, slam: 10, puddleCount: 1, raid: 9, ...beats({ breath: 8, shockwave: 10.5, adds: 34, sweep: 23, hunt: 32, burden: 3.5, yoke: 7.5, schism: 10.0, vigil: 8, chant: 9, gaze: 8, knell: 15, vessel: 17, mirror: 14 }) },
    },
    opening: { slam: 11, raid: 13, ...beats({ breath: 10, shockwave: 15, adds: 42, sweep: 23, hunt: 45, burden: 4.5, yoke: 8.5, schism: 9.0, vigil: 9, chant: 10, gaze: 9, knell: 12, vessel: 14, mirror: 10 }) },
    lines: {
