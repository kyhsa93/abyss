...
function idlePosition(s: SimState, actor: Actor): Vec2 {
  ...
  // Melee stand in melee, except where there is nothing to be in melee with.
  //
  // On the fight that is won by healing the thing in the middle, standing on
  // it is not a position -- it is standing on a patient. It also quietly
