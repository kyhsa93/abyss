...
const BOSS_EFFECTS: Record<string, { colour: string; style: HitStyle }> = {
  ...
  boss_boarding: { colour: '#10b981', style: 'crush' },
  boss_mortar: { colour: '#f472b6', style: 'burst' },
  boss_rocket: { colour: '#fdba74', style: 'burst' },
  boss_axes: { colour: '#7c3aed', style: 'crush' },
  boss_hull: { colour: '#0891b2', style: 'crush' },
  boss_cannon: { colour: '#ec4899', style: 'burst' },
  ...
  // The half of a cultist wave that shoots. Its own entry rather than the
  // thrall's, because the whole of what makes it a different body is that it
