...
const BOSS_EFFECTS: Record<string, { colour: string; style: HitStyle }> = {
  ...
  boss_boarding: { colour: '#b91c1c', style: 'crush' },
  boss_mortar: { colour: '#ea580c', style: 'burst' },
  boss_rocket: { colour: '#f59e0b', style: 'burst' },
  boss_axes: { colour: '#a16207', style: 'crush' },
  boss_hull: { colour: '#78716c', style: 'crush' },
  boss_cannon: { colour: '#0ea5e9', style: 'burst' },
