...
export const LPC_ROW: Record<string, number> = {
  ...
  'add-ooze': 28,
  'add-herald': 29,
  'shield/crusader:slash:behind': 30,
  'shield/crusader:slash:front': 31,
  'shield/crusader:spellcast:behind': 32,
  'shield/crusader:spellcast:front': 33,
  'shield/heater:slash:behind': 34,
  'shield/heater:slash:front': 35,
  'shield/heater:spellcast:behind': 36,
  'shield/heater:spellcast:front': 37,
  'shield/plus:slash:behind': 38,
  'shield/plus:slash:front': 39,
  'shield/plus:spellcast:behind': 40,
  'shield/plus:spellcast:front': 41,
  'shield/scutum:slash:behind': 42,
  'shield/scutum:slash:front': 43,
  'shield/scutum:spellcast:behind': 44,
  'shield/scutum:spellcast:front': 45,
  'shield/spartan:slash:behind': 46,
  'shield/spartan:slash:front': 47,
  'shield/spartan:spellcast:behind': 48,
  'shield/spartan:spellcast:front': 49,
  'shield/two_engrailed:slash:behind': 50,
  'shield/two_engrailed:slash:front': 51,
  'shield/two_engrailed:spellcast:behind': 52,
  'shield/two_engrailed:spellcast:front': 53,
  'weapon/blunt/flail:slash:behind': 54,
  'weapon/blunt/flail:slash:front': 55,
  'weapon/blunt/flail:spellcast:behind': 56,
  'weapon/blunt/flail:spellcast:front': 57,
  'weapon/blunt/mace:slash:behind': 58,
  'weapon/blunt/mace:slash:front': 59,
  'weapon/blunt/mace:spellcast:behind': 60,
  'weapon/blunt/mace:spellcast:front': 61,
  'weapon/blunt/waraxe:slash:behind': 62,
  'weapon/blunt/waraxe:slash:front': 63,
  'weapon/magic/simple:spellcast:behind': 64,
  'weapon/magic/simple:spellcast:front': 65,
  'weapon/polearm/halberd:slash:behind': 66,
  'weapon/polearm/halberd:slash:front': 67,
  'weapon/polearm/scythe:slash:behind': 68,
  'weapon/polearm/scythe:slash:front': 69,
  'weapon/ranged/bow/great:shoot:behind': 70,
  'weapon/ranged/bow/great:shoot:front': 71,
  'weapon/ranged/bow/normal:shoot:behind': 72,
  'weapon/ranged/bow/normal:shoot:front': 73,
  'weapon/ranged/bow/recurve:shoot:behind': 74,
  'weapon/ranged/bow/recurve:shoot:front': 75,
  'weapon/sword/arming:slash:behind': 76,
  'weapon/sword/arming:slash:front': 77,
  'weapon/sword/arming:spellcast:behind': 78,
  'weapon/sword/arming:spellcast:front': 79,
  'weapon/sword/dagger:slash:behind': 80,
  'weapon/sword/dagger:slash:front': 81,
  'weapon/sword/longsword:slash:behind': 82,
  'weapon/sword/longsword:slash:front': 83,
  'weapon/sword/rapier:slash:behind': 84,
  'weapon/sword/rapier:slash:front': 85,
  'weapon/sword/rapier:spellcast:behind': 86,
  'weapon/sword/rapier:spellcast:front': 87,
  'weapon/sword/saber:slash:behind': 88,
  'weapon/sword/saber:slash:front': 89,
  'weapon/sword/saber:spellcast:behind': 90,
  'weapon/sword/saber:spellcast:front': 91,
  'weapon/sword/dagger:off:behind': 92,
  'weapon/sword/dagger:off:front': 93,
  'weapon/sword/rapier:off:behind': 94,
  'weapon/sword/rapier:off:front': 95,
  'weapon/sword/saber:off:behind': 96,
  'weapon/sword/saber:off:front': 97,
}
...
export const LPC_ARMS: Record<string, [number, number][]> = {
  ...
  'warrior-protection': [[76, 77], [88, 89], [84, 85], [58, 59], [54, 55]],
  // sword/longsword, blunt/waraxe, polearm/halberd, polearm/scythe
  'warrior-arms': [[82, 83], [62, 63], [66, 67], [68, 69]],
  // sword/arming, sword/saber, sword/rapier, blunt/mace, blunt/flail
  'paladin-protection': [[76, 77], [88, 89], [84, 85], [58, 59], [54, 55]],
  // sword/longsword, blunt/waraxe, polearm/halberd, polearm/scythe
  'paladin-retribution': [[82, 83], [62, 63], [66, 67], [68, 69]],
  // sword/arming, sword/saber, sword/rapier, blunt/mace, blunt/flail
  'paladin-holy': [[78, 79], [90, 91], [86, 87], [60, 61], [56, 57]],
  // magic/simple
  'priest-discipline': [[64, 65]],
  // magic/simple
  'priest-shadow': [[64, 65]],
  // magic/simple
  'druid-restoration': [[64, 65]],
  // magic/simple
  'druid-balance': [[64, 65]],
  // magic/simple
  'shaman-restoration': [[64, 65]],
  // magic/simple
  'shaman-elemental': [[64, 65]],
  // magic/simple
  'mage-frost': [[64, 65]],
  // magic/simple
  'warlock-destruction': [[64, 65]],
  // ranged/bow/normal, ranged/bow/recurve, ranged/bow/great
  'hunter-marksmanship': [[72, 73], [74, 75], [70, 71]],
  // sword/dagger, sword/rapier, sword/saber
  'rogue-assassination': [[80, 81], [84, 85], [88, 89]],
  // blunt/waraxe
  'boss-marrow': [[62, 63]],
  // magic/simple
  'boss-whisper': [[64, 65]],
...
export const LPC_GUARD: Record<string, [number, number][]> = {
  ...
  'warrior-protection': [[34, 35], [30, 31], [42, 43], [46, 47], [38, 39], [50, 51]],
  // heater, crusader, scutum, spartan, plus, two_engrailed
  'paladin-protection': [[34, 35], [30, 31], [42, 43], [46, 47], [38, 39], [50, 51]],
  // heater, crusader, scutum, spartan, plus, two_engrailed
  'paladin-holy': [[36, 37], [32, 33], [44, 45], [48, 49], [40, 41], [52, 53]],
}
...
export const LPC_OFF: Record<string, [number, number][]> = {
  'rogue-assassination': [[92, 93], [94, 95], [96, 97]],
}
