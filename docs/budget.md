...
| --- | ---: | ---: | ---: |
| the script a browser is handed | 106 KB | 500 KB | the same |
| the world a first visit downloads | 3.64 MB | 4.00 MB | the same |
| everything the deploy carries | 32.63 MB | 200.00 MB | not paid |
