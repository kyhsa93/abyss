...
| --- | ---: | ---: | ---: |
| the script a browser is handed | 101 KB | 500 KB | the same |
| the world a first visit downloads | 3.39 MB | 4.00 MB | the same |
| everything the deploy carries | 31.42 MB | 200.00 MB | not paid |
